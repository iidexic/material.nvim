...
M.load = function()
	local plugin_hls = {
		...
		MiniStatuslineFilename = { fg = e.disabled, bg = e.statusline or e.bg },
		MiniStatuslineInactive = { link = "MiniStatuslineFilename" },
		MiniStatuslineModeCommand = { fg = b.statusline, bg = m.yellow, bold = true },
		MiniStatuslineModeInsert = { fg = b.statusline, bg = m.yellow, bold = true },
		MiniStatuslineModeNormal = { fg = b.statusline, bg = e.accent, bold = true },
		MiniStatuslineModeOther = { fg = b.statusline, bg = m.cyan, bold = true },
		MiniStatuslineModeReplace = { fg = b.statusline, bg = m.red, bold = true },
		MiniStatuslineModeVisual = { fg = b.statusline, bg = m.purple, bold = true },
